...
```{r}
# Displaying tables (HTML/PDF)  --------------------
# PDF, more options -> https://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf
view_table <- function(data, caption = NULL, 
                       output = c("html", "html"), nrow = 6, ...)
  {
  library("DT") 
  library(knitr)
  library(kableExtra)
  ...
  if(output == "html") {
    ...
    require("knitr")
    require("kableExtra")
    kable(data, format = "latex", booktabs = TRUE, caption = caption, ...) %>%
